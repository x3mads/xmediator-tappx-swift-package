# XMediatorTappx iOS SDK

This Swift Package contains the pre-built `XMediatorTappx` binary (xcframework) for iOS, distributed via Swift Package Manager.
...
To integrate `XMediatorTappx` into your Xcode project using Swift Package Manager:
...
After resolving, add the `XMediatorTappx` library product to your app target.
